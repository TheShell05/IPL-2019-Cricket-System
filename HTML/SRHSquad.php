...
$c=	mysqli_connect("localhost","root","");
	...
	$query="select p_name, nationality,dob, matches_played,IPL_Debut_Year from players where tid='T04'";
	$query1="select p_name, Style, Runs_Scored,Highest_Score, Average, Strike_Rate, No_of_50, No_of_100, No_of_4, No_of_6 from batsman ba, players p where tid='T04' and p.pid=ba.pid";
	$query2="select p_name, Style1, Wickets_taken, Total_Runs,Best_Figures, Average1, Economy,Four_W, Five_W from players p,bowlers bo where tid = 'T04' and p.pid=bo.pid";

	$data=mysqli_query($c,$query);
	echo "<br><br>";
	print "<h2>Squad Details of SRH:</h2>";
	print "<table border cellpadding=12>";
	print "<tr bgcolor=orange>";
	print "<th bgcolor=orange>Name</th>";
	print "<th bgcolor=orange>Nationality</th>";
	print "<th bgcolor=orange>DOB</th>";
	print "<th bgcolor=orange>Matches Played</th>";
	print "<th bgcolor=orange>Debut Year</th>";
	print "</tr>";
	...
	$data1=mysqli_query($c,$query1);
		echo "<br><br>";
		print "<h2>Batting Details of SRH:</h2>";
		print "<table border cellpadding=12>";
		print "<tr bgcolor=orange>";
		print "<th bgcolor=orange>Name</th>";
		print "<th bgcolor=orange>Style</th>";
		print "<th bgcolor=orange>Runs Scored</th>";
		print "<th bgcolor=orange>Highest_Score</th>";
		print "<th bgcolor=orange>Average</th>";
		print "<th bgcolor=orange>Strike_Rate</th>";
		print "<th bgcolor=orange>4</th>";
		print "<th bgcolor=orange>6</th>";
		print "<th bgcolor=orange>50</th>";
		print "<th bgcolor=orange>100</th>";
	...
	$data2=mysqli_query($c,$query2);
		echo "<br><br>";
		print "<h2>Bowling Details of SRH:</h2>";
		print "<table border cellpadding=12>";
		print "<tr bgcolor=orange>";
		print "<th bgcolor=orange>Name</th>";
		print "<th bgcolor=orange>Style</th>";
		print "<th bgcolor=orange>Wickets</th>";
		print "<th bgcolor=orange>Runs</th>";
		print "<th bgcolor=orange>Best Figures</th>";
		print "<th bgcolor=orange>Average</th>";
		print "<th bgcolor=orange>Economy</th>";
		print "<th bgcolor=orange>4W</th>";
		print "<th bgcolor=orange>5W</th>";
		print "</tr>";
